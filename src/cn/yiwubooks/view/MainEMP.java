...
public class MainEMP {
	...
	public static  void main(String[] args) {
		JFrame f = new  JFrame("reader");
		    ...
		    ImageIcon A1 = new ImageIcon("src/data/MAIN/etopbar.png");//长顶栏
		    ImageIcon B1 = new ImageIcon("src/data/MAIN/etopbarM.png");//短顶栏
		    ImageIcon C1 = new ImageIcon("src/data/MAIN/ebroadside.png");//左栏
		    ImageIcon D1 = new ImageIcon("src/data/MAIN/etouxiang.png");//右上角头像
		    ImageIcon E1 = new ImageIcon("src/data/MAIN/eropbarM2.png");//左上角名字
	        ...
	        b3.addMouseListener(new MouseAdapter() {
				...
				@Override //mouse clicked
			    public void mousePressed(MouseEvent e) {
					JOptionPane.showMessageDialog(null, "暂不支持自行修改密码，请联系管理员修改密码");
			    }});
